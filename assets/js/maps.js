  ...
  const markers = [
    {
      ...
      location: '<h4>Fuji Hakone Izu National Park</h4>',
    ...
    },
    {
      ...
      location: '<h4>Akan Mashu National Park</h4>',
    ...
    },
    {
      ...
      location: '<h4>Shiretoko National Park</h4>',
      data: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid" alt="Fuji-Hakone-Izu National Park">
    ...
    },
    {
      ...
      location: '<h4>Nikko National Park</h4>',
      data: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid" alt="Fuji-Hakone-Izu National Park">
    ...
    },
    {
      ...
      location: '<h4>Keramashoto National Park</h4>',
      data: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid" alt="Fuji-Hakone-Izu National Park">
    ...
    },
    {
      ...
      location: '<h4>Towada Hachimantai National Park</h4>',
      data: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid" alt="Fuji-Hakone-Izu National Park">
    ...
    },
    {
      ...
      location: '<h4>Aso Kuju National Park</h4>',
      data: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid" alt="Fuji-Hakone-Izu National Park">
    ...
    },
    {
      ...
      location: '<h4>Iriomote Ishigaki National Park</h4>',
      data: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid" alt="Fuji-Hakone-Izu National Park">
    ...
    },
    {
      ...
      location: '<h4>Ogasawara National Park</h4>',
      data: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid" alt="Fuji-Hakone-Izu National Park">
  ...
  function addMarker(props) {
    ...
    if(props.location) {
      ...
      google.maps.event.addListener(marker, 'click', (function(i) {
        return function() {
          document.getElementsByClassName('side-column').innerHTML = markers[i].data;
        };
      })(i));
    }
  }

  ...
  const markers = [
    {
      ...
      info: `<img src="assets/images/fuji-hakone-izu.jpg" class="img-fluid my-4" alt="Fuji-Hakone-Izu National Park"></img>
    ...
    },
    {
      ...
      info: `<img src="assets/images/akan-mashu-np.jpg" class="img-fluid my-4" alt="Fuji-Hakone-Izu National Park">
    ...
    },
    {
      ...
      info: `<img src="assets/images/shiretoko-np.jpg" class="img-fluid my-4" alt="Shiretoko National Park">
    ...
    },
    {
      ...
      info: `<img src="assets/images/nikko-np.jpg" class="img-fluid my-4" alt="Nikko National Park">
    ...
    },
    {
      ...
      info: `<img src="assets/images/yakushima_np.jpg" class="img-fluid my-4" alt="Yakushima National Park">
    ...
    },
    {
      ...
      info: `<img src="assets/images/yoshino-kumano-np.jpg" class="img-fluid my-4" alt="Yoshino-Kumano National Park ">
    ...
    },
    {
      ...
      info: `<img src="assets/images/towada-hachimantai-np.jpg" class="img-fluid my-4" alt="Towada Hachimantai National Park">
    ...
    },
    {
      ...
      info: `<img src="assets/images/aso-kuju-np.jpg" class="img-fluid my-4" alt="Aso Kuju National Park">
    ...
    },
    {
      ...
      info: `<img src="assets/images/iriomote-ishigaki-np.jpg" class="img-fluid my-4" alt="Iriomote Ishigaki National Park">
    ...
    },
    {
      ...
      info: `<img src="assets/images/sakai-np.jpg" class="img-fluid my-4" alt="Saikai National Park">
